...
| **이름** | **기능**            | **날짜**                          |
|:------------:|--------------------------|----------------------------------|
| 서영환(팀장)     |전반적인 코드 리뷰 및 코드 오류 수정, 대댓글 등록, 네이버 기사 크롤링 명령어 제작  |          2024.9.11 ~ 9.19              | 
| 이상현(서기)     | 회원가입, 로그인, 로그아웃 기능 구현, 시연영상 제작     |            2024.9.11 ~ 9.12                 |
| 김나현     | 게시글 상세 조회, 게시글 수정, 게시글 삭제, 댓글 등록, 댓글 삭제 기능 구현   |         2024.9.11 ~ 9.16  |
| 남지민     | 게시글 전체 조회, 게시글 특정 단어 검색, 게시글 추천 기능 구현  |          2024.9.11 ~ 9.16           |
| 배민석     | 프로필 조회, 수정, 이메일 인증 기능 구현   |       2024.9.11 ~ 9.18             |
